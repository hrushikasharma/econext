...
const CarbonFootprintForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const mockResponse = {
      carbonFootprint:
        formData.drivingKmPerWeek * 0.2 +
        formData.annualFlights * 0.15 +
        (formData.energyType === 'renewable' ? 0 : 1.5) +
        formData.meatMealsPerWeek * 0.5,
      message: 'This is an estimated carbon footprint based on your answers.',
    };
    setResult({
      carbonFootprint: mockResponse.carbonFootprint.toFixed(2),
